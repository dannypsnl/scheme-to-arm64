...
(module+ test
  ...
  (check-equal? (compile-and-run '(= 1 1)) #t)
  (check-equal? (compile-and-run '(+ 1 1)) 2)
  (check-equal? (compile-and-run '(char=? #\c #\a)) #f)
  (check-equal? (compile-and-run '(char=? #\b #\b)) #t)
  ; (check-equal? (compile-and-run '(char? #\c)) #t)
  (check-equal? (compile-and-run '(char? 1)) #f)
  ; (check-equal? (compile-and-run '(boolean? #f)) #t)
